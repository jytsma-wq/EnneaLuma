...
const translations = {
  en: {
    ...
    heroLead: "A calm international space for psychomatrix, spiritual development, self-discovery, and inner balance.",
    ...
    paymentNote: "This placeholder PayPal link will be replaced when the official PayPal payment link is available.",
    paypalCta: "Open PayPal placeholder",
  ...
  de: {
    ...
    paymentNote: "Dieser Platzhalter-Link zu PayPal wird ersetzt, sobald der offizielle PayPal-Zahlungslink verfügbar ist.",
    paypalCta: "PayPal-Platzhalter öffnen",
  ...
  fr: {
    ...
    paymentNote: "Ce lien PayPal temporaire sera remplacé lorsque le lien de paiement PayPal officiel sera disponible.",
    paypalCta: "Ouvrir le lien PayPal temporaire",
  ...
  es: {
    ...
    paymentNote: "Este enlace temporal de PayPal se reemplazará cuando el enlace oficial de pago de PayPal esté disponible.",
    paypalCta: "Abrir enlace temporal de PayPal",
  ...
  it: {
    ...
    paymentNote: "Questo link PayPal temporaneo sarà sostituito quando sarà disponibile il link ufficiale di pagamento PayPal.",
    paypalCta: "Apri link PayPal temporaneo",
  ...
  ar: {
    ...
    paymentNote: "سيتم استبدال رابط PayPal المؤقت هذا عندما يصبح رابط الدفع الرسمي عبر PayPal متاحًا.",
    paypalCta: "افتح رابط PayPal المؤقت",
  ...
  zh: {
    ...
    paymentNote: "此 PayPal 占位链接将在官方 PayPal 付款链接可用后替换。",
    paypalCta: "打开 PayPal 占位链接",
  ...
  lb: {
    ...
    paymentNote: "Dëse provisoresche PayPal-Link gëtt ersat, soubal den offiziellen PayPal-Bezuelungslink verfügbar ass.",
    paypalCta: "PayPal-Platzhalter opmaachen",
