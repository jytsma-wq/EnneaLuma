...
const translations = {
  en: {
    ...
    storyTitle: "A calm visual path for reflection",
    storyBody: "Soft symbolic spaces for inner clarity, spiritual development and energy balance.",
  ...
  de: {
    ...
    storyTitle: "Ein ruhiger visueller Weg zur Reflexion",
    storyBody: "Sanfte symbolische Räume für innere Klarheit, spirituelle Entwicklung und Energie-Balance.",
  ...
  fr: {
    ...
    storyTitle: "Un chemin visuel calme pour la réflexion",
    storyBody: "Des espaces symboliques doux pour la clarté intérieure, le développement spirituel et l'équilibre énergétique.",
  ...
  es: {
    ...
    storyTitle: "Un camino visual sereno para la reflexión",
    storyBody: "Espacios simbólicos suaves para claridad interior, desarrollo espiritual y equilibrio energético.",
  ...
  it: {
    ...
    storyTitle: "Un percorso visivo calmo per la riflessione",
    storyBody: "Spazi simbolici delicati per chiarezza interiore, sviluppo spirituale ed equilibrio energetico.",
  ...
  ar: {
    ...
    storyTitle: "مسار بصري هادئ للتأمل",
    storyBody: "مساحات رمزية ناعمة للوضوح الداخلي والتطور الروحي وتوازن الطاقة.",
  ...
  zh: {
    ...
    storyTitle: "用于反思的宁静视觉路径",
    storyBody: "柔和的象征空间，面向内在清晰、灵性发展与能量平衡。",
    storyClarity: "内在清晰",
  ...
  lb: {
    ...
    storyTitle: "E rouege visuelle Wee fir Reflexioun",
    storyBody: "Sanft symbolesch Raim fir bannenzeg Kloerheet, spirituell Entwécklung an Energiegläichgewiicht.",
